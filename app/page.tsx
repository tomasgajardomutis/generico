...
export default async function HomePage() {
  ...
  return <>
    ...
    <section className="section page-container"><div className="cta-panel"><div><p className="eyebrow">Arquitectura preparada</p><h2>Publica, mide y mejora sin rehacer tu base.</h2></div><a className="button button-light" href="/blog">Leer recursos <ArrowRight size={18}/></a></div></section>
  </>;
}
