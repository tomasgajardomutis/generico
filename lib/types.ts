...
export type PageItem={id:string;slug:string;title:string;summary:string;body:string;seo_title?:string;seo_description?:string;locale:string;page_type?:PageType;content_data?:PageContentData;is_published:boolean;updated_at?:string};
